<!-- registry-sync: version=8.1.0; skills=1265; stars=25122; updated_at=2026-03-17T11:32:54+00:00 -->
# 🌌 Agentic Awesome Skills: 1,265+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **The Ultimate Collection of 1,265+ Universal Agentic Skills for AI Coding Assistants — Claude Code, Gemini CLI, Codex CLI, GitHub Copilot, Cursor, OpenCode, AdaL, and more**

[![GitHub stars](https://img.shields.io/badge/⭐%2024%2C000%2B%20Stars-gold?style=for-the-badge)](https://github.com/sickn33/agentic-awesome-skills/stargazers)
...
**Agentic Awesome Skills** is a curated, battle-tested library of **1,265+ high-performance agentic skills** designed to work seamlessly across the major AI coding assistants.
...
- [📚 Browse 1,265+ Skills](#browse-1265-skills)
...
**Agentic Awesome Skills** (Release 8.1.0) is a maintenance-focused upgrade that ships three new community skills, repairs legacy metadata drift, and keeps the docs, review flow, and release path aligned.
...
| OpenCode       | `npx agentic-awesome-skills --path .agents/skills` | `opencode run @brainstorming help me plan a feature` |
...
If you have an older clone created around the removed symlink workaround, reinstall into a fresh directory or rerun the `npx agentic-awesome-skills` installer.
...
- an optional batch helper adapted from [issue #274](https://github.com/sickn33/agentic-awesome-skills/issues/274)
...
**Hosted online:** The same app is available at [https://sickn33.github.io/agentic-awesome-skills/](https://sickn33.github.io/agentic-awesome-skills/) and is deployed automatically on every push to `main`. To enable it once: **Settings → Pages → Build and deployment → Source: GitHub Actions**.
...
- [Discussions](https://github.com/sickn33/agentic-awesome-skills/discussions) for questions and feedback.
- [Issues](https://github.com/sickn33/agentic-awesome-skills/issues) for bugs and improvement requests.
...
If this repository has been useful, consider ⭐ starring it!
